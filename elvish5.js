  ...
  function vc_carouselBehaviour($parent) {
    ...
    $carousel.each(function () {
      ...
      if ($this.data('carousel_enabled') !== true && $this.is(':visible')) {
        ...
        /* Get margin-right value from the css grid and apply it to the carousele li items (margin-left), before carousele initialization */
        var carousele_li = jQuery(this).find('.wpb_thumbnails-fluid li');
        carousele_li.css({"margin-left":carousele_li.css("margin-right"), "margin-right":0 });
        ...
        my_swiper = jQuery(this).swiper(jQuery.extend(options, {
          onFirstInit:function (swiper) {
            if (swiper.slides.length < 2) {
              $this.find('.vc-arrow-right,.vc-arrow-left').hide();
    ...
    jQuery('.wpb_gallery_slides').each(function (index) {
      ...
      if (this_element.hasClass('wpb_slider_nivo')) {
        ...
        this_element.find('.nivoSlider').nivoSlider({
          ...
          keyboardNav:false, // Use right & left arrows
